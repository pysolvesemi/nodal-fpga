...
- [ ] PROD-01 — Freeze a measured first-product target
  ...
  - [ ] PROD-01.d Review requirement traceability, unsupported use cases and a realistic characterization/production-test matrix.
...
- [ ] PROD-02 — Silicon bring-up and model correlation
  ...
  - [ ] PROD-02.b Reuse simulation/emulation corpus IDs for logic, routing, memories, clocks and supported hard-macro tests.
...
- [ ] PROD-03 — Small commercial device and SDK release gate
  Depends on: PROD-02, TMC-04, CAD-06, PERF-04.
  ...
  - [ ] PROD-03.d Validate production-test, reliability and release acceptance requirements with the approved evidence matrix.
